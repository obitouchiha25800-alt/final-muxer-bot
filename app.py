        ...
        function updateProgress() {
            document.querySelectorAll('.processing').forEach(div => {
                ...
                .then(d => {
                    ...
                    if(d.percent >= 100) {
                        // FIX 3: 100% hote hi checking ROK DO
...
<body>
    ...
    <div class="box">
        ...
        <form action="/upload_font" method="POST" enctype="multipart/form-data" style="display:flex; gap:10px;">
            <input type="file" name="font_file" accept=".ttf,.otf" style="flex:1;">
            <button type="submit" style="width:auto; padding: 10px; background:#161b22; border:1px solid #30363d;">Upload Font</button>
        </form>
    </div>

    <div style="display:flex; justify-content:space-between; margin-bottom:10px;">
        <h3 style="margin:0;">📂 Files</h3>
        <button onclick="location.reload()" style="width:auto; padding:5px 15px; margin:0; background:#1f6feb; color:white;">Refresh</button>
    </div>
